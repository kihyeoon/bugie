...
- [ ] 월간 요약 섹션
  ...
  - [ ] 전월 대비 증감률 화살표 표시
- [ ] 빠른 입력 버튼 (플로팅 액션 버튼)
- [ ] 캘린더 날짜 탭 → 거래 목록으로 네비게이션
- [ ] 사용자 인사말 헤더 ("안녕하세요, {닉네임}님")

#### [TAB-03] 빠른 입력 화면 (네이티브)
- [ ] 커스텀 숫자 키패드 UI
  - [ ] 금액 입력 로직 구현
  - [ ] 천 단위 콤마 자동 삽입
  - [ ] 백스페이스 및 00 버튼 구현
...
1. **홈 화면 구현** - 탭 네비게이션과 캘린더 뷰
2. **거래 입력 화면** - 빠른 입력 UI 구현
